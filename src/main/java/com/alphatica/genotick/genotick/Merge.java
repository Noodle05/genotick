        ...
        while(!sourceRobots.isEmpty()) {
            ...
            synchronized(destinationPopulation) {
                ...
                if(moreRobotsNeeded(destinationPopulation, best, worst)) {
                    // Take robot...
                    output.infoMessage(format("Adding robot %s due to destination due to desination not full. Weight: %.4f new size: %d", 
                    ...
                    output.infoMessage(format("Adding robot %s due to destination due to higher score. Weight: %.4f population score: %.4f",
